...
use palang_virtual_machine::{
    assembly::return_type_coercion::ReturnTypeCoercion, boot_machine, choose_llm, virtualization::virtual_machine::VirtualMachine
};
                ...
                Ok(llm) => {
                    match get_assembly_from_file(&args.assembly_file) {
                        Ok(asm) => {
                            ...
                            let return_type_coercion = match &args.return_type {
